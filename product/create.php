...
<?php
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO product_info (product, vendor, quantity, purchase, sale) values ( '$product','$vendor','$quantity','$purchase','$sale')";
        $data = $conn->query($query);
        header("Location: http://localhost/myshop/product/create.php");
    }
?>
