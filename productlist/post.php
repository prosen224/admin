            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    foreach($posts as $k => $v){
                        ?>
                        <div style="border:1px solid #ccc; margin-bottom:15px;padding: 20px;">
                            <h2 style="font-size:25px;"><a href="http://localhost/myshop/productlist/post-details.php?id=<?php echo $v->id?>"><?php echo $v->title; ?></a></h2>
                            <p><?php echo $v->body?></p>
                        </div>
                        <?php
