<?php
    include '../config.php';
    $albums = json_decode(file_get_contents('https://jsonplaceholder.typicode.com/albums'));
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        foreach($albums as $ka => $va){
                            ?>
                                <div class="pro-card">
                                    <div class="card" style="width: 18rem; margin-bottom:10px">
                                        <div class="card-body">
                                            <h5 class="card-title">Album no.<?php echo $va->id ?></h5>
                                            <p class="card-text"><?php echo $va->title ?></p>
                                            <a href="http://localhost/myshop/productlist/album.php?id=<?php echo $va->id ?>" class="btn btn-primary">View Photo</a>
                                        </div>
                                    </div>
                                </div>
